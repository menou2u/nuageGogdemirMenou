...
public class Nuage {
	...
	public static void main(String[] args) {
		 ...
		 * File(Nuage.class.getProtectionDomain().getCodeSource().getLocation().toURI().
		 * getPath()); } catch (URISyntaxException e1) { e1.printStackTrace(); }
		...
		setFrame(new MainWindowFrame(new MainWindow()));
	}
	...
	private static void setFrame(MainWindowFrame frame) {
		Nuage.frame = frame;
	}
}
