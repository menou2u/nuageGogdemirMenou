...
public class runme {
	...
	public static void main(String argv[]) {
		 ...
		 * 
		 * h=giac.add(g,g); h=giac._simplify(h,C);
		 * 
		 * System.out.println( "Value of h: " + h.print(C) ); // h=new
		 * gen(giac.makevecteur(h,new gen(2)),(short)1); h=new
		 * gen(giac.makevecteur(h,new
		 * gen(2),h),(short)gen_comp_subtypes._SEQ__VECT.swigValue());
		 * System.out.println( "Value of h: " + h.print(C) );
		 */
